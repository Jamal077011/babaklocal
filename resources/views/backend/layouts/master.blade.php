...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="{{ asset("backend/assets/img/babak.png")}}" type="image/png">
  <!-- Fonts -->
  ...
  @if(\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()=='ar')
    <link rel="stylesheet" href="{{ asset('backend/assets/css/rtl-aragon.css?v=1.2.0') }}" type="text/css">
  @else
