...
<div class="card-header">
    ...
    <div class="col-8">
        <h3 class="mb-0">Edit Sponsored</h3>
    </div>
...
<div class="card-body">
    ...
    @method('PUT')
        ...
        <div class="form-group ">
            ...
            <input name="email" type="text" class="form-control" id="exampleFormControlInput1" value="{{$sponsored->email}}">
            @error('email')
                <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="form-group ">
            ...
            <input name="phone" type="text" class="form-control" id="exampleFormControlInput1" value="{{$sponsored->phone}}">
            @error('phone_number')
            <small class="text-danger">{{ $message }}</small>
            @enderror
        </div>
