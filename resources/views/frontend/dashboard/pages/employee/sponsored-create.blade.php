...
<div class="card-header">
    ...
    <div class="col-4 text-right">
        <a href="{{ route('dashboard.employee.sponsored-index') }}" class="btn btn-sm btn-primary"><i class="fas fa-arrow-left"></i>{{__('Dashboard.Go back')}} </a>
    </div>
    </div>
</div>
<div class="card-body">
    ...
    @csrf
        ...
        <div class=" ">
            ...
            <div class=" ">
                <div class="form-group ">
                    <label for="exampleFormControlInput1">{{__('Dashboard.Files')}}</label>
