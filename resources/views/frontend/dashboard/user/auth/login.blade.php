      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-6 col-md-6 mt-5">
          <div class="text-center mt-5">
            <img class="mt-5 img-fluid"src="{{ asset("frontend/assets/img/babak.png")}}" alt="">
          </div>
            ...
            <div class=" px-lg-5 py-lg-5">
              ...
              <form method="POST" action="{{ route('dashboard.login') }}" aria-label="{{ __('Login') }}">
                ...
                <div class="custom-control custom-control-alternative custom-checkbox">
                  ...
                  <label class="custom-control-label mt-2" for="customCheckLogin">
                ...
                <div class="mt-3">
                  <button type="submit" class="btn btn-lg btn-block " style="background-color: #007bff; border-color: #007bff; color:white;">
                    {{ __('Dashboard.Login') }}
                  </button>
                </div>
              </form>
              <div class="text-center mt-3">
                ...
                <a class=" " href="{{route('dashboard.register')}}">
                  Sign up now
                </a>
              </div>
            </div>
