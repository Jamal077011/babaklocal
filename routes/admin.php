...
// Dashboard
    ...
    Route:: resource('admin/all_companies', 'App\Http\Controllers\Backend\Admin\AdminCompanyController');

    Route:: get('admin/all_companies/{id?}/companyFile/fileForm', 'App\Http\Controllers\Backend\Admin\AdminCompanyFileController@FileForm')->name('all_companyfile');
    Route:: post('admin/all_companies/{id?}/companyFile/fileForm', 'App\Http\Controllers\Backend\Admin\AdminCompanyFileController@addCompanyFile')->name('all_companyfile.addCompanyFile');
    
    Route:: get('admin/all_companies/companyFile/{id?}', 'App\Http\Controllers\Backend\Admin\AdminCompanyFileController@show')->name('all_companyfile.show');
    
    Route:: get('admin/all_companies/companyFile/renew/{id?}', 'App\Http\Controllers\Backend\Admin\AdminCompanyFileController@renew')->name('all_companyfile.renew');
    
    Route:: get('admin/all_companies/companyFile/edit/{id?}', 'App\Http\Controllers\Backend\Admin\AdminCompanyFileController@edit')->name('all_companyfile.edit');
    Route:: put('admin/all_companies/companyFile/edit/{id?}', 'App\Http\Controllers\Backend\Admin\AdminCompanyFileController@update')->name('all_companyfile.update');

    Route:: post('admin/all_companies/companyFile/{id?}', 'App\Http\Controllers\Backend\Admin\AdminCompanyFileController@destroy')->name('all_companyfile.destroy');
